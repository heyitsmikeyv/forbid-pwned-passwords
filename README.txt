...
is sent to [the API](https://api.pwnedpasswords.com) in order to produce a list of hashes for local testing. This means **no passwords are ever sent to third parties**. 
